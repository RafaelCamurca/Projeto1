...
<head>
    ...
    <link rel="stylesheet" href="/ccbs/CSSS/diesaw/diesaw_style_editar.css">
        ...
        <div class="form">
            <form action="/ccbs/php/diesaw/proc_editblade_diesaw.php" method="POST">
                <div class="form-header">
                    <div class="title">
                        <h2>Editar Vida Útil da Blade</h2>
                    </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-box">
                        <label>PN Único</label>
                        <input type="text" name="partnumberunico" value="<?php echo $row_usuario['partnumber_unico'];?>">
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <label for="usado">Quantos (M) foi usado?</label>
