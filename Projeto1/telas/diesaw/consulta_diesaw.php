...
<head>
    ...
    <link rel="stylesheet" href="/ccbs/CSSS/diesaw/diesaw_style_consulta.css">
    ...
    <div class="container">
        <div class="m-5">
            <table class="table table-hover table-bordered table-sm table-dark" style="border-color: white;">
                <thead>
                <td colspan="10"><h1 style="text-align: center;">Histórico Blades</h1></td>
                    <tr>
                        <th scope="col" style='text-align: center'>PN Único</th>
                        <th scope="col" style='text-align: center'>PN do Cliente</th>               
                        ...
                        <th scope="col" style='text-align: center'>Vida Atual(M)</th>
                ...
                <tbody>
                    ...
                    while($user_data = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td style='text-align: center'>".$user_data['marca']."</td>";
                        ...
                        echo "<td style='text-align: center'>".$user_data['vidautil']."</td>";

                        $idoficial = $user_data['id'];
                        $usadooficial = $usado;
                        $pnn = $user_data['id'];
                        $vida = $user_data['vidautil'];

                        $sql2 = "SELECT usado, vidautilblade, reason FROM editblade_diesaw WHERE $pnn=idblade";
                        ...
                        $restante = $vida - $totalusado;

                        echo "<td style='text-align: center'>".$restante."</td>";
                        ...
                        $porcentagem = (($vida - $totalusado)/$vida)*100;
                        ...
                        if ($porcentagem<=40 or $reason==$reason1 or $reason==$reason2){
