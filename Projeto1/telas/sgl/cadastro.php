...
<head>
    ...
    <link rel="stylesheet" href="/ccbs/CSSS/sgl/sgl_style_cadastro.css">
        ...
        <div class="form">
            <form action="/ccbs/php/sgl/processa.php" method="POST">
                ...
                <div class="input-group">
                    <div class="input-box">
                        <label for="marca">Marca da Blade</label>
                    ...
                    <div class="input-box">
                        <label for="vidautil">Vida Útil da Blade</label>
                        <input id="vidautil" maxlength="5" type="esp" name="vidautil" placeholder="00000" required>
                    </div>
                    <div class="input-box">
                        <label for="partnumber">PartNumber Blade</label>
