...
<head>
    ...
    <link rel="stylesheet" href="/ccbs/CSSS/sgl/sgl_style_detalhes.css">
        ...
        <div class="m-5">
            <table class="table table-hover table-bordered table-sm table-dark table-responsive" style="border-color: white;">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style='text-align: center'>PN Fornecedor</th>
            ...
            <div class="input-box">
                <div class="input-group mb-0">
                    <span class="input-group-text">Usado Atualmente</span>
