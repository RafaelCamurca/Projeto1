    ...
    <div class="container">
        <div class="m-5">
            <table class="table table-hover table-bordered table-sm table-dark" style="border-color: white; font-size:small;">
                <thead>
                    <tr>
                        <th scope="col" colspan="18" style='text-align: center; font-size: 20px;'>POGO PIN CONTAGEM  - BGA 132B 12x18</th>
                    </tr>
                    <tr>
        ...
        <div class="continue-button" style="margin-left: 1100px;">
            <a class="btn btn-primary" href="updatepogopinbga132.php" role="button" style="font-size: small;">Atualizar</a>
