        ...
        <div class="form">
            <form action="calculadora.php" method="GET">
                ...
                <div class="input-group">
                    <div class="input-box">
                        <label for="tipo">Tipo de Compound</label>
                        <input name="tipo" type="text" placeholder="5.5 ou 7.0" maxlength="3" required>
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="input-box">
                        <label for="und_lot">Quantidade de Portas</label>
                        <input id="und_lot" maxlength="1" type="text" name="doors" placeholder="Qty Doors" required>
                    </div>
                    <div class="input-box">
                        <label for="und_lot">Quantidade de lots</label>
                        <input id="und_lot" maxlength="2" type="text" name="qty_lot" placeholder="Qty Lot" required>
                    </div>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="input-box">
                        <label for="und">Quantidade de Substrate</label>
                        <input id="und" maxlength="3" type="text" name="qty_sub" placeholder="Qty Substrate" required>
                    </div>
                    <div class="calc-button">
                        <input type="submit" name= "calcular" value="Calcular" class="btn btn-block btn-primary" style="width: 415px;">
                    </div>
